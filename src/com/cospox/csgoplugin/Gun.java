...
public class Gun {
	public static Gun[] guns = {new Gun(Gun.GunType.AK47, 0.2, 0.01, 0.5, 10, 200, 0.01, 10, 1),
								new Gun(Gun.GunType.M4A1S,0.2, 0.01, 0.5, 10, 200, 0.01, 20, 2),
								new Gun(Gun.GunType.AWP,  1.0, 0.01, 1.5, 15, 400, 0.02, 30, 3)};
	...
	private Gun(GunType type, double sprayNormal, double sprayCrouch, double spraySprint, int damage, int range, double radius, int cooldown, int customModelData) {
		this.type = type;
